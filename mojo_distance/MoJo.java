...
public class MoJo {
    ...
    public static void main(String[] args) {
        try
        {
            ...
            if (args.length > 2)
            {
                ...
                /* -b indicates double direction it.unisa.sesa.MoJo */
                if (args[2].equalsIgnoreCase("-b"))
                {
                    mjc = new MoJoCalculator(sourceFile, targetFile, relFile);
                    long one = mjc.mojo();
                ...
                {
                    mjc = new MoJoCalculator(sourceFile, targetFile, relFile);
                    System.out.println(mjc.mojofm()[0]);
                }
                else
    ...
    private static void showerrormsg() {
        ...
        System.out.println("");
        System.out.println("java mojo.it.unisa.sesa.MoJo a.rsf b.rsf");
        System.out.println("  calculates the one-way it.unisa.sesa.MoJo distance from a.rsf to b.rsf");
        System.out.println("java mojo.it.unisa.sesa.MoJo a.rsf b.rsf -fm");
        System.out.println("  calculates the MoJoFM distance from a.rsf to b.rsf");
        System.out.println("java mojo.it.unisa.sesa.MoJo a.rsf b.rsf -b");
        System.out.println("  calculates the two-way it.unisa.sesa.MoJo distance between a.rsf and b.rsf");
        System.out.println("java mojo.it.unisa.sesa.MoJo a.rsf b.rsf -e r.rsf");
        System.out.println("  calculates the EdgeMoJo distance between a.rsf and b.rsf");
        System.out.println("java mojo.it.unisa.sesa.MoJo a.rsf b.rsf -m+");
